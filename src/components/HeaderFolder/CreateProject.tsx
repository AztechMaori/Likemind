...
function Modal(props: ModalProps) {
  ...
  return (
    <>
      <div class="  bg-black w-3/4 h-1/2 fixed top-1/2 bottom-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10 ">
          ...
          <>
            <div class="w-full h-full bg-red-500">
              ...
              <div class="h-4/6 w-full flex flex-wrap bg-orange-500">
                ...
                <button class="bg-pink-500 w-1/3 h-full flex justify-center items-center font-bold btn-pop" onClick={() => { setStage(4) }}>Options</button>
              </div>
...

        {
          stage() === 2 ? (
            ...
            <CreateGroup setStage={setStage} setConfirmedUsers={setConfirmedUsers} ConfirmedUsers={confirmedUsers} />

          ) : (null)
        }
        {stage() === 3 ? (<CreateDescription setStage={setStage} setDescription={setDescripton} Description={description} />) : (null)}
        {stage() === 4 ? (<SetOptions setStage={setStage} />) : (null)}
