...
export default function FinalisedUser(props: FinalisedUserProps) {
  return (
    <div class="w-full h-full flex flex-wrap justify-evenly ">
      {props.ConfirmedPortfolio.map((item) => {
        return (
          <div class="ml-2 relative  min-w-fit mr-2 mt-2 p-2 rounded-lg bg-black min-w-40 w-1/3 h-1/4">
            ...
            <button class="remove-user h-5 w-5 flex justify-center items-center absolute bg-red-500 rounded-full" onClick={() => remove_user(props.ConfirmedPortfolio, props.setConfirmedPortfolio, item)}>X</button>
